...
<body>
				...
				<table class="content_table" style="width:75%">
					...
					<tbody>
						...
						<tr>
							...
							<td>&nbsp;<input type="text" id="_pwd" name="pw" value="" data-msg="암호를" size="20" title="패스워드" style="border:1px solid #dddddd;" />
						</tr>
						<tr>
							<td colspan="2" style="height:50px; text-align:center; ">
								<span>
									<a href="#" id="_btnlogin" title="로그인">
										<img src="image/login_btn.jpg" alt="로그인"/>
									</a>
									<a href="#" id="_btnRegi" title="회원가입">
	...
	<script type="text/javascript">
		$("#_btnlogin").click(function name(){
			if($("#_userid").val() == ""){
				alert($("#_userid").attr("data-msg") + " 입력해 주싯슈!!!");
				$("#_userid").focus();
			}else if($("#_pwd").val() == ""){
				alert($("#_pwd").attr("data-msg") + " 입력해 주싯슈!!!!");
				$("#_pwd").focus();
			}else{
